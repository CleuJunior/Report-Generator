defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many/1" do
    test "when a file list is provided, builds the report" do
      ...
      expect_response = {:ok,
      %{"foods" => %{"açaí" => 2, "churrasco" => 4, "esfirra" => 6, "hambúrguer" => 4, "pastel" => 0, "pizza" => 4, "prato_feito" => 0, "sushi" => 0},
      "users" => %{"1" => 96, "10" => 72, "11" => 0, "12" => 0, "13" => 0, "14" => 0, "15" => 0, "16" => 0, "17" => 0, "18" => 0, "19" => 0, "2" => 90, "20" => 0, "21" => 0, "22" => 0, "23" => 0, "24" => 0, "25" => 0, "26" => 0, "27" => 0, "28" => 0, "29" => 0, "3" => 62, "30" => 0, "4" => 84, "5" => 98, "6" => 36, "7" => 54, "8" => 50, "9" => 48}}}

      # ASSERTION
      assert response == expect_response
    end
    test "when a file list is not provided, returns an error" do
      reponse = ReportsGenerator.build_from_many("test")
